...
class TextValidator(Module):
    ...
    def _get_miner_prediction(
        ...
        log(f"Prompting miner {module_ip}:{module_port} with key: {self.key}")
        log(f"Miner key:{miner_key}")
        try:
    ...
    async def validate_step(
        ...
        log(f"Miner information: {modules_info}")
